...
<body class="Verdana-font">
 ...
 <!--             <div class="alert alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<form action="http://34.102.191.145/VisibilityAssetTracker/downloadPromoFromListing.htm" method="POST" enctype="multipart/form-data" id="download">
          ...
          $(document).ready(function(){
        		  ...
        		  $('#delete_promo').on('click',function(){
        		    $('#successblock').hide();
      				...
      				//$("#delete_promo").attr("href", "http://34.102.191.145/VisibilityAssetTracker/deletePromotion.htm?promoid="+promoIdList);
