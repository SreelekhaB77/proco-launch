...
<body class="Verdana-font">
 ...
 <!--             <div class="alert succ-alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<form action="http://34.120.182.42/VisibilityAssetTracker/downloadPromoFromListing.htm" method="POST" enctype="multipart/form-data" id="download">
          ...
          $(document).ready(function(){
        		  ...
        		  $('#delete_promo').on('click',function(){
        		    $('#successblock').hide();
      				...
      				//$("#delete_promo").attr("href", "http://34.120.182.42/VisibilityAssetTracker/deletePromotion.htm?promoid="+promoIdList);
