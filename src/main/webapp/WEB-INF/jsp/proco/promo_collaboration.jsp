...
<body class="Verdana-font">
	...
	<div class="container-fluid container-bg middle-section">
		...
		<c:if test="${errorMsg!=null}">
			<div class="alert err-alert-danger sucess-msg" id="errorblock" style="margin-top:35px;">
				...
				<c:if test="${FILE_STATUS=='ERROR_FILE'}">
					<a href="https://vat.hulcd.com/VisibilityAssetTracker/downloadKamUploadErrorFilensp.htm?level=${level}" id="downloadTempFileLink">Click
		...
		<!--Kajal added code for errorblock with download error file for KAM volume upload sprint-10-->
                                    ...
                                    <div class="alert alert-danger" style="display: none;margin-top:35px;margin-bottom: -23px" id="KAMVolumeerrorblockUpload">
                                        <button type="button" class="close" data-hide="alert">&times;</button>
                                            ...
                                            <a href="https://vat.hulcd.com/VisibilityAssetTracker/downloadKamUploadErrorFilensp.htm" id="downloadTempFileLink">Click here to Download Error File</a>
                                    </div>
		...
		<div class="proco-creation form-horizontal">
			...
			<form action="https://vat.hulcd.com/VisibilityAssetTracker/downloadKAMDPUploadPrimaryChannelwise.htm" method="POST"
