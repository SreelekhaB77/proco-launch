 ...
 <jsp:include page="../proco/proco-header.jsp" />  
  ...
  <div class="container-fluid middle-section" style="margin-top:0px;">
    ...
    <div class="col-md-6 col-md-offset-3" style="margin-top:50px;">
         ...
         <a href="https://vat.hulcd.com/VisibilityAssetTracker/promoCreation.htm">
  ...
  <div class="col-md-12 col-md-offset-2">
         ...
         <a href="https://vat.hulcd.com/VisibilityAssetTracker/promoDisaggregation.htm">
           ...
           <div class="promo-create promo-listing-bg">
             ...
             <div class="col-md-2 col-sm-6 col-xs-6 ">
               <!--  <a href="https://vat.hulcd.com/VisibilityAssetTracker/getAllCompletedLaunchDataDp.htm">
    ...
    <div class="col-md-6 col-md-offset-4">
            ...
            <div class="col-md-4 col-sm-6 col-xs-6 ">
                 <a href="https://vat.hulcd.com/VisibilityAssetTracker/promoCollaboration.htm">
    	...
    	<div class="col-md-4 col-md-offset-4">
         ...
         <a href="https://vat.hulcd.com/VisibilityAssetTracker/promoCr.htm">
          <div class="promo-create promo-create-bg">
              <img src="assets/images/proco/icon-1.png"  class="img-responsive" alt="">
