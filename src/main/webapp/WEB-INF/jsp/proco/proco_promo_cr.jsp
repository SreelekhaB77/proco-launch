...
<body class="Verdana-font">
 ...
 <!--             <div class="alert alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<form action="http://34.102.191.145/VisibilityAssetTracker/rejectCr.htm" method="POST" enctype="multipart/form-data" id="download">
          ...
          $(document).ready(function(){
    		  ...
    		  $('#approveCr').on('click',function(){
    			  $('#successblock').hide();
    				...
    				$("#approveCr").attr("href", "http://34.102.191.145/VisibilityAssetTracker/approveCr.htm?promoid="+promoIdList);
    				} else{
