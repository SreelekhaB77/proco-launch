...
<body class="Verdana-font">
 ...
 <!--             <div class="alert succ-alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<form action="http://34.120.182.42/VisibilityAssetTracker/rejectCr.htm" method="POST" enctype="multipart/form-data" id="download">
          ...
          $(document).ready(function(){
    		  ...
    		  $('#approveCr').on('click',function(){
    			  $('#successblock').hide();
    				...
    				$("#approveCr").attr("href", "http://34.120.182.42/VisibilityAssetTracker/approveCr.htm?promoid="+promoIdList);
    				} else{
