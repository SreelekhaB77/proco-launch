			...
			<div class="">
				<div class="row">
					<ul class="nav nav-pills">
						...
						<li role="presentation" class="col-md-3 col-sm-6 col-xs-12 proco-craetion-active"><a href="http://34.102.191.145/VisibilityAssetTracker/promoCreation.htm">
						...
						<li role="presentation"
							class="col-md-3 col-sm-6 col-xs-12 listing"><a href="http://34.102.191.145/VisibilityAssetTracker/promoDeletion.htm">
	...
	<div class="container-fluid container-bg middle-section">
		...
		<c:if test="${errorMsg!=null}">
			<div class="alert alert-danger sucess-msg" id="errorblock">
				...
				<c:if test="${FILE_STATUS=='ERROR_FILE'}">
					<a href="http://34.102.191.145/VisibilityAssetTracker/downloadPromotionErrorFile.htm" id="downloadTempFileLink">Click
		...
		<div class="proco-creation form-horizontal">
			...
			<!-- <div class="promo-back">
				<a href="http://34.102.191.145/VisibilityAssetTracker/procoHome.htm"><span
					class="glyphicon glyphicon-arrow-left" aria-hidden="true"> </span></a>Promotion
				Creation
			</div> -->
			<form:form action="http://34.102.191.145/VisibilityAssetTracker/createPromotion.htm"
			...
			<form:form action="http://34.102.191.145/VisibilityAssetTracker/uploadPromoCreation.htm" id="promoCreateUpload"
			...
			<!-- <div class="sample-upload-file">
				 <span><i class="glyphicon glyphicon-cloud-download"></i></span> <span>
					<a href="http://34.102.191.145/VisibilityAssetTracker/downloadPromotionTemplateFile.htm" style="color: #ffffff"
					id="downloadTemplate" class="modelClick"><b
						class="SEGOEUIL-font">Click here to download the Template file</b></a>
				</span>
			</div> -->
			<form:form action="http://34.102.191.145/VisibilityAssetTracker/downloadPromotionTemplateFile.htm" id="getPromoTemplate"
...
<form id="pwdform" method="post" action="" class="form-horizontal" style="padding: 10px 0;">
	...
	function getMocMonth(selectedDate){
		...
		url : "http://34.102.191.145/VisibilityAssetTracker/getMocMonthForProco.htm?startDate=" + $('#startdate').val()+"&endDate="+$('#enddate').val(),
