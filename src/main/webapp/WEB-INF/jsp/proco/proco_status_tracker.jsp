...
<div class="loader">
			...
			<div class="">
				<div class="row">
					...
					<li role="presentation"
							...
							href="http://34.120.182.42/VisibilityAssetTracker/promoStatusTracker.htm">
 ...
 <!--             <div class="alert succ-alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<form action="http://34.120.182.42/VisibilityAssetTracker/downloadPromoStatusTracker.htm" method="POST" enctype="multipart/form-data" id="download">
						...
						<div class="col-md-6 col-sm-6 ddd">
								<div class="procoupload-parent" style="min-height: 275px !important;">
									<div style="text-align: center; color: #878787;">
										...
										<form style="display: inline-block;" action="http://34.120.182.42/VisibilityAssetTracker/downloadCustomerPortalPromoStatusTracker.htm" method="post">
