			...
			<div class="">
				<div class="row">
					...
					<li role="presentation"
							...
							href="https://vat.hulcd.com/VisibilityAssetTracker/promoStatusTracker.htm">
						...
						<li role="presentation"
							...
							<a href="http://vat.hulcd.com/VisibilityAssetTracker/promoDeletion.htm" style="width:225px;">
						...
						<!--<li role="presentation"	class="col-md-3 col-sm-6 col-xs-12 timeline" style="width:19%">
							<a href="http://vat.hulcd.com/VisibilityAssetTracker/procoTimeline.htm" style="width:230px;">
				...
				<div class="row">
					<ul class="nav nav-pills">
						<li role="presentation"	class="col-md-3 col-sm-6 col-xs-12 visibility-bg"  style="margin-top: 10px;width:21%">
							<a href="http://vat.hulcd.com/VisibilityAssetTracker/procovisibilityUpload.htm" style="margin-left: 6%;">
								<div class="proco-ppm-icon"></div>
						...
						<div class="col-md-6 col-sm-6 ddd">
								<div class="procoupload-parent" style="min-height: 275px !important;">
									<div style="text-align: center; color: #878787;">
										...
										<form style="display: inline-block;" action="https://vat.hulcd.com/VisibilityAssetTracker/downloadCustomerPortalPromoStatusTracker.htm" method="post">
