...
<div class="loader">
			...
			<div class="">
				<div class="row">
					...
					<li role="presentation"
							...
							href="http://34.102.191.145/VisibilityAssetTracker/promoStatusTracker.htm">
 ...
 <!--             <div class="alert alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<form action="http://34.102.191.145/VisibilityAssetTracker/downloadPromoStatusTracker.htm" method="POST" enctype="multipart/form-data" id="download">
