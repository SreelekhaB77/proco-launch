	              ...
	              <span></span>
	               ...
	               <div class="alert alert-danger" style="display: none;margin-top:35px;margin-bottom: -23px" id="ProcoApprovalUploaderrorblock">
	                               <button type="button" class="close" data-hide="alert">&times;</button>
	                                   ...
	                                   <a href="http://localhost:8083/VisibilityAssetTracker/downloadSCApprovalPromotionErrorFile.htm" id="downloadTempFileLink">Click here to Download Error File</a>
	                           </div>
