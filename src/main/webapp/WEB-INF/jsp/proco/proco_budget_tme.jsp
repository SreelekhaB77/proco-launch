				...
				<div class="row">
					<ul class="nav nav-pills nav-no-margin">
						<c:if test="${roleId eq 'TME'}">
							...
							<li role="presentation"
							class="col-md-3 col-sm-6 col-xs-12 listing"><a href="http://vat.hulcd.com/VisibilityAssetTracker/promoDeletion.htm">
		...
		<c:if test="${errorMsg!=null}">
			<div class="alert err-alert-danger sucess-msg" id="errorblock" style="margin-top:35px;">
				...
				<c:if test="${FILE_STATUS=='ERROR_FILE'}">
					<a href="http://vat.hulcd.com/VisibilityAssetTracker/downloadPromotionEditErrorFile.htm" id="downloadTempFileLink">Click
