...
<body>
	...
	<c:if test="${FILE_STATUS=='SUCCESS_FILE'}">
		...
		<c:if test="${errorMsg!=null}">
			<div class="alert err-alert-danger sucess-msg" id="errorblock"  style="margin-top:35px;" >
				...
				<c:if test="${FILE_STATUS=='ERROR_FILE'}">
					<a href="http://34.120.182.42/VisibilityAssetTracker/downloadPromotionVolumeErrorFile.htm" id="downloadTempFileLink">Click
		...
		<div class="proco-creation form-horizontal">
			...
			<form action="http://34.120.182.42/VisibilityAssetTracker/downloadPromosForVolumeUpload.htm" method="POST" enctype="multipart/form-data">
			...
			<form:form action="http://34.120.182.42/VisibilityAssetTracker/uploadPromoVolume.htm" id="promoVolumeUpload"
