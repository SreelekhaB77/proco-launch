...
<body class="Verdana-font">
					...
					<ul class="nav nav-pills nav-no-margin">
						<c:if test="${roleId eq 'TME'}">
							...
							<li role="presentation"
								...
								href="http://34.120.128.205/VisibilityAssetTracker/promoDeletion.htm">
						...
						<c:if test="${roleId eq 'COE'}">
							...
							<li role="presentation"
								...
								href="http://34.120.128.205/VisibilityAssetTracker/ProcoMeasureReportUploadPage.htm"
								id="measHref">
							...
							<li role="presentation"
								...
								<a
								href="http://34.120.128.205/VisibilityAssetTracker/ProcoPpmCoeRemarks.htm">
							...
							<li role="presentation"
								...
								<a
								href="http://34.120.128.205/VisibilityAssetTracker/procoLiveBudget.htm"
								style="width: 247px;">
									<div class="proco-budget-icon "></div>
									<div class="tab-label-proco-budget-inactive OpenSans-font">Budget Report</div>
							</a>
				...
				<div class="row">
					<ul class="nav nav-pills nav-no-margin">
						<li role="presentation"
							...
							href="http://34.120.128.205/VisibilityAssetTracker/procovisibilityUpload.htm" style="margin-left: 6%;">
								<div class="proco-ppm-icon"></div>
 ...
 <!--             <div class="alert succ-alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<!--<form action="http://34.120.128.205/VisibilityAssetTracker/downloadDeletedPromo.htm" method="POST" enctype="multipart/form-data" id="download">
