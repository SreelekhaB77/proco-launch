...
<body class="Verdana-font">
				...
				<div class="row">
					<ul class="nav nav-pills">
					 ...
					 <li role="presentation" class="col-md-3 col-sm-6 col-xs-12 create"><a
							href="http://34.102.191.145/VisibilityAssetTracker/promoCreation.htm">
					...
					<li role="presentation"
						...
						<li role="presentation"
							class="col-md-3 col-sm-6 col-xs-12 proco-del-active"><a href="http://34.102.191.145/VisibilityAssetTracker/promoDeletion.htm">
					 ...
					 <li role="presentation" class="col-md-3 col-sm-6 col-xs-12 create"><a
							href="http://34.102.191.145/VisibilityAssetTracker/promoCr.htm">
								<div class="proco-create-icon"></div>
					...
					<a href="http://34.102.191.145/VisibilityAssetTracker/promoStatusTracker.htm">
								<div class="proco-listing-icon"></div>
						...
						<a href="http://34.102.191.145/VisibilityAssetTracker/promoDeletion.htm" style="margin-top: 10px;margin-left: -23px;">
								<div class="proco-deletion-icon"></div>
								<div class="tab-label-proco-create-active OpenSans-font">Dropped Offer</div>
						</a></li>
					 <li role="presentation" class="col-md-3 col-sm-6 col-xs-12 promo-lib-bg" style="margin-top: 10px;">
							<a href="http://34.102.191.145/VisibilityAssetTracker/ProcoMeasureReportUploadPage.htm" id="measHref">
		...
		<c:if test="${errorMsg!=null}">
			<div class="alert alert-danger sucess-msg" id="errorblock">
				...
				<c:if test="${FILE_STATUS=='ERROR_FILE'}">
					<a href="http://34.102.191.145/VisibilityAssetTracker/downloadPromotionEditErrorFile.htm" id="downloadTempFileLink">Click
 ...
 <!--             <div class="alert alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<div class="proco-creation form-horizontal">
			...
			<!-- <div class="promo-back"><a href="http://34.102.191.145/VisibilityAssetTracker/procoHome.htm"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"> </span></a>Promo Listing</div> -->
		...
		<form action="http://34.102.191.145/VisibilityAssetTracker/downloadDeletedPromo.htm" method="POST" enctype="multipart/form-data" id="download">
		<input type="hidden" name="remarkText" id="remarkText" value="" />
			...
			<%-- </c:if> --%>
			<%-- <c:if test="${roleId eq 'TME'}">
			<form:form action="http://34.102.191.145/VisibilityAssetTracker/uploadPromoEdit.htm" id="promoEditUpload"
      ...
      <div class="modal-content">
		...
		<div class="modal-body">
			<div class="row">
<form id="pwdform" method="post" action="http://34.102.191.145/VisibilityAssetTracker/deletePromotion.htm" class="form-horizontal" style="padding: 10px 0;">
		...
		var mocVal = null;
          ...
          $(document).ready(function(){
        		  ...
        		  $('#duplicate_promo').on('click',function(){
      				...
      				$("#duplicate_promo").attr("href", "http://34.102.191.145/VisibilityAssetTracker/duplicatePromotion.htm?promoid="+promoIdList);
      				} else{
        		  ...
        		  $('#edit_promo').on('click',function(){
        			  $('#successblock').hide();
        				...
        				if(promoIdList.length>0){
        				$("#edit_promo").attr("href", "http://34.102.191.145/VisibilityAssetTracker/editPromotion.htm?promoid="+promoIdList);
        				} else{
            				$('#promoSelectErrorMsg').show().find('span').html('Please select Promotion.');
            				}
          		  });
        		  ...
        		  $('#create_promo').on('click',function(){
        			...
        			$("#create_promo").attr("href", "http://34.102.191.145/VisibilityAssetTracker/promoCreation.htm");
