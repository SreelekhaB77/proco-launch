			...
			<div class="">
				<div class="row">
					...
					<li role="presentation"
						...
						<li role="presentation"
							class="col-md-3 col-sm-6 col-xs-12 proco-del-active"><a href="http://34.120.128.205/VisibilityAssetTracker/promoDeletion.htm">
					...
					<a href="http://34.120.128.205/VisibilityAssetTracker/promoStatusTracker.htm" style="margin-left:-27px;" >
								<div class="proco-listing-icon"></div>
						...
						<li role="presentation" class="col-md-3 col-sm-6 col-xs-12 proco-del-active"style=" margin-top: 10px; margin-right:-60px; margin-left:-10px  ">
							<a href="http://34.120.128.205/VisibilityAssetTracker/promoDeletion.htm" style="width:220px;">
								<div class="proco-deletion-icon"></div>
								<div class="tab-label-proco-create-active OpenSans-font"  style="padding-top: 15px;">Dropped Offer</div>
						</a></li>
