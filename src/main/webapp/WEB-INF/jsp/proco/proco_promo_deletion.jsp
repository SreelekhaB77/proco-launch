...
<body class="Verdana-font">
 ...
 <!--             <div class="alert succ-alert-success sucess-msg" id="successblock1" style="display:none">
		...
		<div class="proco-creation form-horizontal">
			...
			<!--bharati commented below div for sprint-9 moc changes-->
			...
			<!--</div>-->
			<!--bharati commented below form for sprint-9 moc changes-->
		<!--<form action="https://vat.hulcd.com/VisibilityAssetTracker/downloadDeletedPromo.htm" method="POST" enctype="multipart/form-data" id="download">
      ...
      <div class="modal-content">
		...
		<div class="modal-body">
			<div class="row">
<form id="pwdform" method="post" action="https://vat.hulcd.com/VisibilityAssetTracker/deletePromotion.htm" class="form-horizontal" style="padding: 10px 0;">
		...
		var mocVal = null;
          ...
          $(document).ready(function(){
        		  ...
        		  $('#duplicate_promo').on('click',function(){
      				...
      				$("#duplicate_promo").attr("href", "https://vat.hulcd.com/VisibilityAssetTracker/duplicatePromotion.htm?promoid="+promoIdList);
      				} else{
        		  ...
        		  $('#edit_promo').on('click',function(){
        			  $('#successblock').hide();
        				...
        				if(promoIdList.length>0){
        				$("#edit_promo").attr("href", "https://vat.hulcd.com/VisibilityAssetTracker/editPromotion.htm?promoid="+promoIdList);
        				} else{
            				$('#promoSelectErrorMsg').show().find('span').html('Please select Promotion.');
            				}
          		  });
        		  ...
        		  $('#create_promo').on('click',function(){
        			...
        			$("#create_promo").attr("href", "https://vat.hulcd.com/VisibilityAssetTracker/promoCreation.htm");
