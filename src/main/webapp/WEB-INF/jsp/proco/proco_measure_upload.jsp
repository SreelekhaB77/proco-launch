...
<body class="Verdana-font">
				...
				<div class="row">
					...
					<li role="presentation" class="col-md-3 col-sm-6 col-xs-12 proco-listing-inactive">
						...
						<li role="presentation"	class="col-md-3 col-sm-6 col-xs-12 promo-lib-bg-active">
							<a href="http://34.102.191.145/VisibilityAssetTracker/ProcoMeasureReportUploadPage.htm" style="margin-top: 10px;">
		 ...
		 <div class="promo-upload">PROCO MEASURE REPORT UPLOAD</div>
							<div class="row">
								<div class="col-md-6 col-sm-6 ddd">
									<form id="coeStatusMeasFileUpload" class="form-horizontal" action="http://34.102.191.145/VisibilityAssetTracker/uploadProcoMeasureReport.htm" method="post" enctype="multipart/form-data" name="coeStatusFileUpload">
									...
									<div class="launchupload-parent">
										<div class="proco-measure-upload-wrapper">
											<div style="text-align: center; color: #878787;">
												...
												<a href="http://34.102.191.145/VisibilityAssetTracker/downloadSampleMeasureReport.htm" class="validate_upload btn marginT10 btn-primary" id="btnSubmitBasePack">Promo Measure Template</a>
											</div>
										</div>
									</div>
								</form> 
							...
							<div class="col-md-6 col-sm-6 ddd">
							 	<form action="http://34.102.191.145/VisibilityAssetTracker/downloadMeasureReport.htm" id="download-measure-report" method="POST" onsubmit="downloadMeasureReport(event)">
							 		<div class="launchupload-parent">
	...
	<%-- <form:form action="http://34.102.191.145/VisibilityAssetTracker/uploadProcoMeasureReport.htm" id="coeStatusMeasFileUpload"
