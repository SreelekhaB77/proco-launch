				...
				<div class="row">
					...
					<li role="presentation" class="col-md-3 col-sm-6 col-xs-12 proco-listing-inactive">
						...
						<li role="presentation"	class="col-md-3 col-sm-6 col-xs-12 promo-lib-bg-active">
							<a href="http://34.120.128.205/VisibilityAssetTracker/ProcoMeasureReportUploadPage.htm" style="margin-top: 10px;">
								...
								<!--bharati changes this below form for sprint-9 US-15 ppminkageupload-->
									...
									<div class="launchupload-parent">
										<div class="proco-measure-upload-wrapper">
											...
											<a href="http://34.120.128.205/VisibilityAssetTracker/promoMeasureDownloadTemplate.htm" class="validate_upload btn marginT10 new-btn-download" id="btnSubmitBasePack">Promo Measure Template</a>
											</div>
										</div>
									</div>
								</form> 
