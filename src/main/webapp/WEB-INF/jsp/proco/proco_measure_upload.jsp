		 ...
		 <div class="promo-measure-upload">PROCO MEASURE REPORT UPLOAD</div>
							<div class="row">
								<div class="col-md-6 col-sm-6 ddd">
									<form id="coeStatusMeasFileUpload" class="form-horizontal" action="https://vat.hulcd.com/VisibilityAssetTracker/uploadProcoMeasureReport.htm" method="post" enctype="multipart/form-data" name="coeStatusFileUpload">
