					...
					<div class="row">
						<ul class="nav nav-pills">
							...
							<li role="presentation"
								...
								<a href="http://34.102.191.145/VisibilityAssetTracker/getAllCompletedLaunchDataKam.htm"> <!-- <div class="launch-icon"></div> -->
									<div class="tab-label-launch">Launch Details</div>
							</a>
							</li>
							<li role="presentation"
								class="active col-md-2 col-sm-8 col-xs-12 launch-icon-active">
								<a href="http://34.102.191.145/VisibilityAssetTracker/getApprovalStatusKam.htm"> <!-- <div class="launch-icon"></div> -->
