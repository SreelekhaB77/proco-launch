...
<body class="OpenSans-font">
					...
					<div class="row">
						<ul class="nav nav-pills">
							...
							<li role="presentation" class="active col-md-3 col-sm-8 col-xs-12 launch-icon-active">
								<a href="https://vat.hulcd.com/VisibilityAssetTracker/getAllCompletedLaunchDataSc.htm"> <!-- <div class="launch-icon"></div> -->
	...
	<div class="container-fluid container-bg middle-section">
		...
		<div class="alert alert-danger marginT15" id="errorblockUpload">
					...
					<!--  <a href="https://vat.hulcd.com/VisibilityAssetTracker/downloadTmeUploadErrorFile.htm" id="downloadTempFileLink">Click here to Download Error File</a> -->
				</div>
