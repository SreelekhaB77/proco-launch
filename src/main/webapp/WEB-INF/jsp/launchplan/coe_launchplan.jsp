					...
					<div class="row">
						<ul class="nav nav-pills">
							...
							<li role="presentation" class="active col-md-3 col-sm-8 col-xs-12 launch-icon-active">
								<a href="https://vat.hulcd.com/VisibilityAssetTracker/getAllCompletedLaunchData.htm"> <!-- <div class="launch-icon"></div> -->
											...
											<thead class="thead-dark">
											   <!--sprint-4 US-2.2 original MOC Changes Bharati-->
												<tr>
													...
													<th style="min-width:115px!important"><span class="proco-btn proco-btn-success table-head">Original MOC</span></th>
