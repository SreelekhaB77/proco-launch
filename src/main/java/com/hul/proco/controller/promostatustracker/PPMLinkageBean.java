...
public class PPMLinkageBean {
	...
	public String toString() {
		return "PPMLinkageBean [file=" + file + ", version_promo_id=" + version_promo_id + ", chart_by_type="
				...
				+ PROMOTION_END_DATE + ", PRE_DIP_START_DATE=" + PRE_DIP_START_DATE + ", POST_DIP_END_DATE="
				+ POST_DIP_END_DATE + ", CUSTOMER=" + CUSTOMER + ", BUSINESS=" + BUSINESS + ", DIVISION=" + DIVISION
				+ ", PRODUCT=" + PRODUCT + ", CATEGORY=" + CATEGORY + ", PROMOTION_STATUS=" + PROMOTION_STATUS
				+ ", INVESTMENT_TYPE=" + INVESTMENT_TYPE + ", MOC=" + MOC + ", SUBMISSION_DATE=" + SUBMISSION_DATE
				+ ", APPROVED_DATE=" + APPROVED_DATE + ", MODIFIED_DATE=" + MODIFIED_DATE + ", PROMOTION_TYPE="
				+ PROMOTION_TYPE + ", DURATION=" + DURATION + ", FREE_PRODUCT_NAME=" + FREE_PRODUCT_NAME
				+ ", PRICE_OFF=" + PRICE_OFF + ", BASELINE_QUANTITY=" + BASELINE_QUANTITY + ", BASELINE_GSV="
				+ BASELINE_GSV + ", BASELINE_TURNOVER=" + BASELINE_TURNOVER + ", BASELINE_GROSS_PROFIT="
				+ BASELINE_GROSS_PROFIT + ", PROMOTION_VOLUME_BEFORE=" + PROMOTION_VOLUME_BEFORE
				+ ", PROMOTION_VOLUME_DURING=" + PROMOTION_VOLUME_DURING + ", PROMOTION_VOLUME_AFTER="
				+ PROMOTION_VOLUME_AFTER + ", PLANNED_GSV=" + PLANNED_GSV + ", PLANNED_TURNOVER=" + PLANNED_TURNOVER
				+ ", PLANNED_INVESTMENT_AMOUNT=" + PLANNED_INVESTMENT_AMOUNT + ", PLANNED_UPLIFT=" + PLANNED_UPLIFT
				+ ", PLANNED_INCREMENTAL_GROSS_PROFIT=" + PLANNED_INCREMENTAL_GROSS_PROFIT + ", PLANNED_GROSS_PROFIT="
				+ PLANNED_GROSS_PROFIT + ", PLANNED_INCREMENTAL_TURNOVER=" + PLANNED_INCREMENTAL_TURNOVER
				+ ", PLANNED_CUSTOMER_ROI=" + PLANNED_CUSTOMER_ROI + ", PLANNED_COST_PRICE_BASED_ROI="
				+ PLANNED_COST_PRICE_BASED_ROI + ", PLANNED_PROMOTION_ROI=" + PLANNED_PROMOTION_ROI
				+ ", ACTUAL_QUANTITY=" + ACTUAL_QUANTITY + ", ACTUAL_GSV=" + ACTUAL_GSV + ", ACTUAL_TURNOVER="
				+ ACTUAL_TURNOVER + ", ACTUAL_INVESTMENT_AMOUNT=" + ACTUAL_INVESTMENT_AMOUNT + ", ACTUAL_UPLIFT="
				+ ACTUAL_UPLIFT + ", ACTUAL_INCREMENTAL_GROSS_PROFIT=" + ACTUAL_INCREMENTAL_GROSS_PROFIT
				+ ", ACTUAL_GROSS_PROFIT=" + ACTUAL_GROSS_PROFIT + ", ACTUAL_INCREMENTAL_TURNOVER="
				+ ACTUAL_INCREMENTAL_TURNOVER + ", ACTUAL_CUSTOMER_ROI=" + ACTUAL_CUSTOMER_ROI
				+ ", ACTUAL_COST_PRICE_BASED_ROI=" + ACTUAL_COST_PRICE_BASED_ROI + ", ACTUAL_PROMOTION_ROI="
				+ ACTUAL_PROMOTION_ROI + ", UPLOAD_REFERENCE_NUMBER=" + UPLOAD_REFERENCE_NUMBER + ", IS_DUPLICATE="
				+ IS_DUPLICATE + ", ERROR_MSG=" + ERROR_MSG + ", ROW_NO=" + ROW_NO + ", USER_ID=" + USER_ID + ", moc="
				+ moc + ", investment_amount=" + investment_amount + "]";
	}
