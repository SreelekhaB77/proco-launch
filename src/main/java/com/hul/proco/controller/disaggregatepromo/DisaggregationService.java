...
public interface DisaggregationService  {
	...
	public int getDisaggregationRowCount(String cagetory, String brand, String basepack, String custChainL1, String custChainL2, 
			String offerType, String modality, String year, String moc, String userId);
	
	public List<DisaggregationBean> getDisaggregationTableList(int pageDisplayStart, int pageDisplayLength, String cagetory, String brand,
