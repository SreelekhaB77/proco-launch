...
public class EditPromoBean {
	...
	public String toString() {
		return "EditPromoBean [offerValue=" + offerValue + ", offerType=" + offerType + ", year=" + year + ", moc="
				+ moc + ", modality=" + modality + ", geography=" + geography + ", kittingValue=" + kittingValue
				+ ", customerChainL1=" + customerChainL1 + ", customerChainL2=" + customerChainL2 + ", uom=" + uom
				+ ", thirdPartyDesc=" + thirdPartyDesc + ", thirdPartyRatio=" + thirdPartyRatio + ", promoDesc="
				+ promoDesc + ", basepack1=" + basepack1 + ", brand1=" + brand1 + ", basepackDesc1=" + basepackDesc1
				+ ", ratio1=" + ratio1 + ", basepack2=" + basepack2 + ", category2=" + category2 + ", brand2=" + brand2
				...
				+ childBasepackDesc6 + ", childRatio6=" + childRatio6 + "]";
	}
}
