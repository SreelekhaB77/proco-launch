	...
	public List<ArrayList<String>> getDetailsofDP(ArrayList<String> header) {
		...
		try {
			String query_list = "SELECT PM.CHANNEL_NAME, PM.MOC, PM.PROMO_ID, CM.SECONDARY_CHANNEL, CM.PPM_ACCOUNT,"
					...
					+ "PM.OFFER_TYPE, PM.OFFER_MODALITY, PM.PRICE_OFF, '' AS QUANTITY, PM.BRANCH, PM.CLUSTER, PM.TEMPLATE_TYPE AS PROMO_TEMPLATE, SUBSTRING(PM.CREATED_DATE,1,10) AS CREATED_DATE,PM.TEMPLATE_TYPE AS REMARK "
