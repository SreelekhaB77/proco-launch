...
public class CreatePromotionBean {
	...
	@Column(name = "Start Date(DD/MM/YYYY)")
	private String startDate;
	
	@Column(name = "End Date(DD/MM/YYYY)")
	private String endDate;
	
	private String startDateForDb;
	private String endDateForDb;
	...
	@Column(name="Changes Made")
	private String changesMade;
	
	private String offerValDrop="";
	...
	public String getStartDateForDb() {
		return startDateForDb;
	}

	public void setStartDateForDb(String startDateForDb) {
		this.startDateForDb = startDateForDb;
	}
	...
	public void setEndDateForDb(String endDateForDb) {
		this.endDateForDb = endDateForDb;
	}
	...
	public String getOfferValDrop() {
		return offerValDrop;
	}

	public void setOfferValDrop(String offerValDrop) {
		this.offerValDrop = offerValDrop;
	}

	@Override
	public String toString() {
		return "CreatePromotionBean [file=" + file + ", uniqueId=" + uniqueId + ", offerValue=" + offerValue
				+ ", offerType=" + offerType + ", year=" + year + ", moc=" + moc + ", modality=" + modality
				+ ", geography=" + geography + ", kittingValue=" + kittingValue + ", customerChainL1=" + customerChainL1
				+ ", customerChainL2=" + customerChainL2 + ", uom=" + uom + ", thirdPartyDesc=" + thirdPartyDesc
				+ ", thirdPartyRatio=" + thirdPartyRatio + ", promoDesc=" + promoDesc + ", basepack1=" + basepack1
				+ ", category1=" + category1 + ", brand1=" + brand1 + ", basepackDesc1=" + basepackDesc1 + ", ratio1="
				+ ratio1 + ", basepack2=" + basepack2 + ", category2=" + category2 + ", brand2=" + brand2
				+ ", basepackDesc2=" + basepackDesc2 + ", ratio2=" + ratio2 + ", basepack3=" + basepack3
				+ ", category3=" + category3 + ", brand3=" + brand3 + ", basepackDesc3=" + basepackDesc3 + ", ratio3="
				+ ratio3 + ", basepack4=" + basepack4 + ", category4=" + category4 + ", brand4=" + brand4
				+ ", basepackDesc4=" + basepackDesc4 + ", ratio4=" + ratio4 + ", basepack5=" + basepack5
				+ ", category5=" + category5 + ", brand5=" + brand5 + ", basepackDesc5=" + basepackDesc5 + ", ratio5="
				+ ratio5 + ", basepack6=" + basepack6 + ", category6=" + category6 + ", brand6=" + brand6
				+ ", basepackDesc6=" + basepackDesc6 + ", ratio6=" + ratio6 + ", childBasepack1=" + childBasepack1
				+ ", childCategory1=" + childCategory1 + ", childBrand1=" + childBrand1 + ", childBasepackDesc1="
				+ childBasepackDesc1 + ", childRatio1=" + childRatio1 + ", childBasepack2=" + childBasepack2
				+ ", childCategory2=" + childCategory2 + ", childBrand2=" + childBrand2 + ", childBasepackDesc2="
				+ childBasepackDesc2 + ", childRatio2=" + childRatio2 + ", childBasepack3=" + childBasepack3
				+ ", childCategory3=" + childCategory3 + ", childBrand3=" + childBrand3 + ", childBasepackDesc3="
				+ childBasepackDesc3 + ", childRatio3=" + childRatio3 + ", childBasepack4=" + childBasepack4
				+ ", childCategory4=" + childCategory4 + ", childBrand4=" + childBrand4 + ", childBasepackDesc4="
				+ childBasepackDesc4 + ", childRatio4=" + childRatio4 + ", childBasepack5=" + childBasepack5
				+ ", childCategory5=" + childCategory5 + ", childBrand5=" + childBrand5 + ", childBasepackDesc5="
				+ childBasepackDesc5 + ", childRatio5=" + childRatio5 + ", childBasepack6=" + childBasepack6
				+ ", childCategory6=" + childCategory6 + ", childBrand6=" + childBrand6 + ", childBasepackDesc6="
				+ childBasepackDesc6 + ", childRatio6=" + childRatio6 + ", startDate=" + startDate + ", endDate="
				+ endDate + ", startDateForDb=" + startDateForDb + ", endDateForDb=" + endDateForDb + ", reason="
				+ reason + ", remark=" + remark + ", changesMade=" + changesMade + ", offerValDrop=" + offerValDrop
				+ "]";
	}
