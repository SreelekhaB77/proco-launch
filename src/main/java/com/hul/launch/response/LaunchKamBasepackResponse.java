...
public class LaunchKamBasepackResponse {
	...
	public String getBasepackId() {
		return basepackId;
	}

	public void setBasepackId(String basepackId) {
	...
	public String toString() {
		return "LaunchKamLaunchResponse [launchName=" + launchName + ", basepackId=" + basepackId + ", salesCat="
				+ salesCat + ", psaCat=" + psaCat + ", brand=" + brand + ", bpCode=" + bpCode + ", bpDisc=" + bpDisc
				+ ", mrp=" + mrp + ", tur=" + tur + ", gsv=" + gsv + ", cldConfig=" + cldConfig + ", grammage="
				+ grammage + ", classification=" + classification + "]";
	}
}