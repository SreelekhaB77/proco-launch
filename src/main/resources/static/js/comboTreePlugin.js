...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.init = function () {
        // Setting Doms
        this.comboTreeId = 'comboTree' + this.elemInput.id;
        ...
        this._elemArrowBtn = $('<span id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn"><span class="comboTreeArrowBtnImg"><i class="glyphicon glyphicon-triangle-bottom"></i></span></span>')
                        .css({
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        if (this.options.isMultiple)
            itemHtml += '<span data-id="' + sourceItem.id + '" class="comboTreeItemTitle '+this.comboTreeId+'"><input type="checkbox">' + sourceItem.title + '</span>';
        else
            itemHtml += '<span data-id="' + sourceItem.id + '" class="comboTreeItemTitle '+this.comboTreeId+'">' + sourceItem.title + '</span>';
    ...
    ComboTree.prototype.singleItemClick = function (ctItem) {
       ...
       // this.options.select(this._selectedItem);
    ...
    ComboTree.prototype.multiItemClick = function (ctItem) {
        ...
        if (index){
            ...
            //blocked list on click
            //$(ctItem).find("input").prop( "checked", false );  
            //$(ctItem).find("input").trigger('change');
        }
        else {
